...
class Processor():
    def __init__(self, arg):
        ...
        self.arg.model_args['num_classes'] = 1116#len(self.gloss_dict) + 1                                                                     here
    ...
    def loading(self):
        ...
        if self.arg.load_weights:
            print("4.1")
            print("Loading weights from {}".format(self.arg.load_weights))
    ...
    def load_model_weights(self, model, weight_path):
        ...
        model.load_state_dict(weights, strict=True)                                                                                #error here
