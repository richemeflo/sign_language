...
class BaseFeeder(data.Dataset):
    ...
    def read_video(self, index):
        ...
        img_folder = os.path.join(self.prefix, "features/fullFrame-256x256px/" + fi['folder'][:-7]+"*.png") 
        ...
        return [[cv2.cvtColor(cv2.imread(img_path), cv2.COLOR_BGR2RGB) for img_path in img_list], label_list, fi]  # modif
